...
class Higher_education_cost_calculator extends Controller
{
    ...
    public function calculate(Request $request): JsonResponse
    {
        $rules = [
            ...
            'loan_interest_rate_pct' => 'nullable|numeric|min:0',   // ✅ optional
            ...
            'discount_inflation_rate_pct' => 'nullable|numeric|min:0', // ✅ optional
        ];
        ...
        try {
            ...
            $data = [
                ...
                'roi_percent'            => round((float)$roiPercent, 2),
                'rates_used' => [
                    'loan_interest_rate_pct' => $loanRatePct,
                    'loan_rate_source'       => $loanRateSource,
                    'discount_inflation_rate_pct' => $discountPct,
                    'discount_rate_source'   => $discountSource,
                ]
            ];
            ...
            Log::error('Exception in Higher_education_cost_calculator::calculate', [
